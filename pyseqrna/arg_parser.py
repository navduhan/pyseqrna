...
def parse_args():
    ...
    internal.add_argument( "--paired", dest='paired', action='store_true', default=False,   default='pySeqRNA_results', 
    ...
    internal.add_argument('--noreplicate', dest='noreplicate',action='store_false', default=False ,
    ...
    tools.add_argument('--aligner', dest='aligner', default='STAR', choices=['STAR', 'hisat2'], 
