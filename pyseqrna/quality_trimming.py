...
def flexbarRun(sampleDict,  configFile=None, slurm=False, mem=10, cpu=8, task=1, paired=False, outDir=None, dryrun=False, dep=''):
    ...
    output =  pu.get_basename(str(flexbar_config[0]).split(" ")[1])
    ...
    if os.path.exists(outDir):
        ...
        output = pu.make_directory(base, dryrun=dryrun)
...
def trimmomaticRun(sampleDict=None, configFile=None, slurm=False, mem=10, cpu=8, task=1, paired=False, outDir=None, dryrun=False, dep=''):
...
def trim_galoreRun(sampleDict=None,  configFile=None, slurm=False, mem=10, cpu=8, task=1, paired=False, outDir=None, dryrun = False, dep=''):
    """ This function is to perform adapter and quality based trimming of reads using trmmomatic trimming tool
